...
class AsyncImageSender(object):
    ...
    def __init__(self, server_name="server", server_ip='127.0.0.1', port=5555, send_timeout=0, recv_timeout=0,
        ...
        :param server_name: Name of the server to send to.  The server can have many named receivers and this name
                            should uniquely identify a particular server instance.
        :type server_name:
        :param server_ip:
        :type server_ip:
        :param port:
        :type port:
        :param send_timeout: @see ImageSender
        :type send_timeout:
        :param recv_timeout: @see ImageSender
        :type recv_timeout:
        :param show_frame_rate: for debugging and performance testing
        :type show_frame_rate:
        :param backlog: Maximun number of images in the queue waiting to be sent before new messages are discarded.
        :type backlog:
        """
